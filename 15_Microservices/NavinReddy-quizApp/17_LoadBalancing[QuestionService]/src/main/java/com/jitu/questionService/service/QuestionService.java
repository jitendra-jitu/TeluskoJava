package com.jitu.questionService.service;

//import com.telusko.quizapp.Question;

import com.jitu.questionService.dao.QuestionDao;
...
//                .toList();
    ...
    public ResponseEntity<List<Question>> addQuestion(Question question) {
        ...
        return new ResponseEntity<>(Collections.singletonList(questionDao.save(question)),HttpStatus.CREATED);
//        return questionDao.findAll();
    }

    public ResponseEntity<List<Integer>> createQuestions(String category, int numberOfQuestions,String title) {
